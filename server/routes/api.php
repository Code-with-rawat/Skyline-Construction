...
use App\Http\Controllers\front\TestmonialController as FrontTestmonialController;
...
Route::get('get-testmonials',[FrontTestmonialController::class,'index']);
Route::get('get-latest-testmonials',[FrontTestmonialController::class,'latestTestmonials']);
